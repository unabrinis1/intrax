...
$sql_comments = "SELECT h.id, h.comentario, h.fecha, u.usuario AS autor 
...
<head>
    ...
    <title>Ver Ticket - Panel de Administrador</title>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form method="POST" action="ver_ticket_admin.php?id=<?= $ticket_id; ?>">
        ...
        <form method="POST" action="../controlador/agregar_comentario_admin.php">
            <input type="hidden" name="ticket_id" value="<?= $ticket['id']; ?>">
        ...
        <a href="admin_home.php" class="btn btn-secondary mt-3">Volver al Panel</a>
    </div>
</body>
</html>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt_update->execute()) {
        echo "<script>alert('Ticket actualizado correctamente'); window.location.href = 'ver_ticket_admin.php?id=$ticket_id';</script>";
    } else {
