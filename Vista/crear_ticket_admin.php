...
<head>
    ...
    <title>Crear Ticket - Panel de Admin</title>
...
<body>
    <div class="container mt-5">
        ...
        <form id="ticketForm" action="../controlador/procesar_ticket_admin.php" method="post" onsubmit="return validarUsuario()">
...
<a href="admin_home.php" class="btn btn-secondary mt-3">
        ...
        $(document).ready(function() {
            $('#buscarUsuario').on('input', function() {
                ...
                if (query.length > 1) { // Buscar solo si hay al menos 2 caracteres
                    $.ajax({
                        url: '../controaldor/buscar_usuario.php',
                        type: 'GET',
                        data: { query: query },
