...
<body>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <button onclick="window.location.href='crear_ticket_agente.php'" class="btn btn-primary mr-2"> <i class="fas fa-plus-circle"></i> Crear Nuevo Ticket</button>
        ...
        <form method="POST" action="agente_home.php" class="mb-4">
            <div class="form-row">
                <div class="col">
        ...
        <div class="row mb-4">
            ...
            <!-- Boton buscar Tickets -->

        <form method="POST" action="agente_home.php" class="d-flex mb-4">
